...
.zi-get-latest-gh-r-url-part() {
  ...
  matchstr=(
    ...
    cygwin    "(windows|cygwin|(-|_)win|win64|win32|winnt|winnt64|windows-gnu)"
    windows   "(windows|cygwin|(-|_)win|win64|win32|winnt|winnt64|windows-gnu)"
    msys      "(windows|msys|msys2|cygwin|(-|_)win|win64|win32|winnt|winnt64|windows-gnu)"
    mingw     "(windows|mingw|mingw64|cygwin|(-|_)win|win64|win32|winnt|winnt64|windows-gnu)"
