...
They are [ZI Extensions](https://github.com/search?q=topic%3Azi-annex+org%3Az-shell&type=Repositories). An annex is added to ZI by simply loading it
...
[**zi/z-a-submods**](https://github.com/z-shell/z-a-submods) annex). It
shows how to:
